...
## 🦊 ADDENDUM — FOXCONN / FII (Added July 2026)

> **Foxconn was NOT in the original document.** Reason: Foxconn is primarily a contract manufacturer,
> not a product software company. However, its subsidiary **Foxconn Industrial Internet (FII)** is a
> pure tech company doing exactly Industrial IoT + AI + Cloud + Smart Factory — your SentinelGrid domain.
> **Critical for you:** FII signed a ₹1,600 Cr deal to build a new facility in **Kancheepuram, Tamil Nadu**
> (~40 km from Chennai) and signed a research partnership with **IIT Madras**.

---

### FOXCONN ENTITY MAP

| Entity | What It Does | Tech Relevance |
|--------|-------------|---------------|
| **Hon Hai Precision (Parent)** | iPhone/server contract manufacturing | Low SW content |
| **Foxconn Industrial Internet (FII)** | Industrial IoT, AI servers, smart factory, cloud | ✅ VERY HIGH — your domain |
| **FII USA Inc.** | 5G, Industrial AI, IoT, Industry 4.0 | ✅ VERY HIGH |
| **Sharp Corporation (subsidiary)** | Consumer electronics, displays, IoT | ✅ Moderate |

---

### FII / FOXCONN — ALL LOCATIONS WITH SALARY IN INR LPA

| # | Entity | Country | City | Role | Local Salary | INR LPA | Work Mode | Career Page |
|---|--------|---------|------|------|-------------|---------|-----------|-------------|
| A1 | **FII India (Kancheepuram)** | India | Kancheepuram, TN (~40 km Chennai) | Industrial IoT Engineer | ₹7–16 LPA | ₹7–16 LPA | On-site | fii-foxconn.com/careers |
| A2 | **FII India + IIT Madras JV** | India | Chennai | Embedded SW / AI Engineer | ₹10–20 LPA | ₹10–20 LPA | Hybrid | fii-foxconn.com/careers |
| A3 | **Foxconn India (Sriperumbudur)** | India | Sriperumbudur, TN (~35 km Chennai) | SW Engineer (MES/IoT/Automation) | ₹6–14 LPA | ₹6–14 LPA | On-site | naukri.com → Foxconn |
| A4 | **FII USA Inc.** | USA | Houston, TX | SW Engineer (Industrial AI/IoT) | $65–100K | ₹62–96 LPA | Hybrid | builtin.com → Foxconn Industrial Internet |
| A5 | **FII USA Inc.** | USA | Wisconsin / Durham NC | Industrial AI Engineer | $65–100K | ₹62–96 LPA | Hybrid | fii-foxconn.com/careers |
| A6 | **Foxconn Taiwan HQ** | Taiwan | New Taipei City | Software Engineer | TWD 950K–1.5M | ₹24–38 LPA | Hybrid | jobs.foxconn.com |
| A7 | **FII (Shenzhen HQ)** | China | Shenzhen | Embedded/IoT Engineer | CNY 180–280K | ₹21–33 LPA | On-site | fii-foxconn.com/careers |
| A8 | **Sharp Corporation** | Japan | Osaka | Embedded Software Engineer | ¥4.5–6.5M | ₹28–41 LPA | Hybrid | sharp.co.jp/recruit |
| A9 | **Sharp India** | India | Mumbai/Chennai | Software Engineer | ₹5–12 LPA | ₹5–12 LPA | Hybrid | sharp-world.com/recruit |

---

### WHAT FII ACTUALLY BUILDS (Your Domain Alignment)

FII works on:
- **NVIDIA AI server manufacturing** — GB200 and GB300 AI supercomputer systems
- **Industrial IoT platforms** — sensors → edge → cloud (identical to SentinelGrid architecture)
- **Smart factory MES systems** — real-time machine monitoring (= what SentinelGrid does)
- **5G private networks** for factories and warehouses

| Your Project | FII Equivalent | Match |
|-------------|---------------|-------|
| **SentinelGrid** (Industrial IoT AI on ESP32) | FII Smart Factory IoT platform | ✅ Perfect — this IS their product |
| **TFLite Micro + FreeRTOS + C** | Industrial edge inference on constrained hardware | ✅ Perfect |
| **MQTT + AWS IoT Core** | FII factory telemetry pipeline | ✅ Strong |
| **Grafana + TimescaleDB** | Manufacturing OEE dashboards | ✅ Strong |

### Salary Honesty Note
FII USA pays $65–100K for software roles (lower than FAANG, similar to mid-tier). India IT roles
pay ₹6–20 LPA. Most India headcount is factory workers — make sure you apply specifically to
**Software Engineer / Embedded Engineer / IoT Engineer** tracks, not general hiring.

### How to Apply (India)
```
Portal 1: fii-foxconn.com/careers → Filter India → Software/Embedded roles
Portal 2: naukri.com → Search "Foxconn" → Filter CS/IT
Portal 3: LinkedIn → Search "FII India" OR "Foxconn Industrial Internet India"
Portal 4: Campus: Watch for FII drives at IIT Madras, Anna University, NIT Trichy
Cover letter tip: Mention SentinelGrid explicitly — "I built an industrial anomaly
detection system on ESP32 + FreeRTOS + MQTT — identical to what FII deploys in
smart factories." This directly speaks to their core product line.
```
